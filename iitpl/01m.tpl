...
%end
        ...
        <li><a href="/{{r.ea}}{{! g_opts(('rev',r.getl.rev),('lim',r.getl.lim))}}" title="Обновить список сообщений"><i class="fa fa-fw fa-refresh"></i></a></li>

            <li class="divider"></li>

        <li><a href="/h/personal" title="Персональные настройки"><i class="fa fa-fw fa-plane"></i></a></li>
...
%end
        ...
        <ul class="left"> 
            ...
            <li class="divider"></li>
%desc = [x for x in r.echolist if x[0] == r.ea]
%if desc:
            <li><a href="/{{r.ea}}">{{desc[0][2]}}</a></li>
%end
        </ul> 
    </section> 
</nav>
